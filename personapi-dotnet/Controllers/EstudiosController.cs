...
namespace personapi_dotnet.Controllers
{
    public class EstudiosController : Controller
    {
        ...
        public EstudiosController(SumaDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sumaDbContext = _context.Estudios.Include(e => e.CcPerNavigation).Include(e => e.IdProfNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SumaDbContext.Estudios'  is null.");
            }
            var estudio = await _context.Estudios.FindAsync(id);
            if (estudio != null)
            {
